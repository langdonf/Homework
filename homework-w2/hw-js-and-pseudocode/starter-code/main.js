...
/*
	...
	Assign these variables an3 positive integer values.
...
for each number in listOfNumbers check to see which is largest,

place larger number in variable largestNumber

Check next number against winner of first matchup, put larger number in variable


ListOfNumbers
smallestnumber = 0

for each number in listOfNumbers check to see which is smallest

place smaller number in variable smallestNumber

Check next number against winner of first matchup, put smaller number in variable
 */
