...
console.log("Part 5 and 6");

let younger2 = [];
var i = ages.length;
while (i > 0) {
	if (ages[i] <= 20) {
		younger2.push(ages[i]);
	}
	i--;	
}
...
var pizza = ['onions', 'olives', 'pineapple'];

function addPepperoniPizza(ingredients) {
	var idx = ingredients.indexOf("pepperoni");
	if (idx == -1){
